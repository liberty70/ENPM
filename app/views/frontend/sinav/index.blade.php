...
@section('content')
        ...
        <div class="row">
				...
				<div class="search-bar">
				    <form class="main-search" action="">
				      <div class="input-group">
				        <input type="text" class="form-control" placeholder="Bulmak istedigin sinavi yaz ...">
        	...
        	<div class="col-md-4">
        		<a href="{{{ URL::route('sinav-ekleme') }}}" class=" pull-right btn btn-success">SINAVLAR EKLE</a>
        	</div>
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-check"></i> Sinavlar buraya yuklenecek, Soldan Bolumu Sec</h4>
                    </div>
